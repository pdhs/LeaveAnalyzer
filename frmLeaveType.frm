...
Option Explicit
    ...
    Dim current As New clsLeaveType
...
Private Sub fillNameCombo()
    ...
    allItems.FillSpecificFieldOrder cmbName, "LeaveType", "LeaveTypeName", "LeaveTypeName", True
End Sub
...
Private Sub cmbName_Change()
    current.LeaveTypeID = Val(cmbName.BoundText)
    Call displayDetails
End Sub
